    ...
    const filteredServices = services.filter(service => {
        ...
        if (filters.foodType !== 'all') {
            if (filters.foodType === 'veg') {
                matchesFood = service.foodType === 'veg';
            } else if (filters.foodType === 'non-veg') {
                matchesFood = service.foodType === 'non-veg';
            } else if (filters.foodType === 'both') {
                matchesFood = service.foodType === 'both';
            }
        }

        const matchesPrice = !filters.maxPrice || service.pricing?.twoTimesPerMonth <= parseInt(filters.maxPrice);

        return matchesSearch && matchesCity && matchesType && matchesFood && matchesPrice;
    });
                                    ...
                                    {service.foodType && (
                                        <span
                                            ...
                                            style={{
                                                ...
                                                border: `1px solid ${getFoodTypeColor(service.foodType)}`,
                                                color: getFoodTypeColor(service.foodType)
                                            }}
                                        >
                                            <div style={{
                                                width: '8px',
                                                height: '8px',
                                                borderRadius: '50%',
                                                backgroundColor: getFoodTypeColor(service.foodType)
                                            }} />
                                            {getFoodTypeLabel(service.foodType)}
                                        </span>
                                    )}
