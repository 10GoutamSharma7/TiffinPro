                                ...
                                {service.foodType && (
                                    <span
                                        ...
                                        style={{
                                            ...
                                            alignItems: 'center',
                                            gap: '8px',
                                            border: `1px solid ${service.foodType === 'veg' ? '#2ecc71' :
                                                    service.foodType === 'non-veg' ? '#e74c3c' : '#f1c40f'
                                                }`,
                                            color: service.foodType === 'veg' ? '#2ecc71' :
                                                service.foodType === 'non-veg' ? '#e74c3c' : '#f1c40f'
                                        }}
                                    >
                                        <div style={{
                                            ...
                                            height: '10px',
                                            borderRadius: '50%',
                                            backgroundColor: service.foodType === 'veg' ? '#2ecc71' :
                                                service.foodType === 'non-veg' ? '#e74c3c' : '#f1c40f'
                                        }} />
                                        {service.foodType === 'veg' ? 'Veg' :
                                            service.foodType === 'non-veg' ? 'Non-Veg' : 'Veg & Non-Veg'}
                                    </span>
                                )}
